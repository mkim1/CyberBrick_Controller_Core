...
sys.path.insert(0, os.path.abspath('../src/app_rc'))
...
micropy_version = _DOC_VERSION or "latest"
micropy_all_versions = (_DOC_ALL_VERSIONS or "latest").split(",")
...
project = "MicroPython for CyberBrick"
copyright = "- The MicroPython Documentation is Copyright © 2014-2025, Damien P. George, Paul Sokolovsky, MakerWorld, and contributors"
...
latex_documents = [
    (
        ...
        "Damien P. George, Paul Sokolovsky, MakerWorld, and contributors",
        "manual",
    ),
]
